...
export default function Footer() {
    return <footer className="border-t border-white/[.06] bg-[#07080a] px-5 pb-7 pt-20 text-white lg:px-10">
        <div className="mx-auto grid max-w-7xl gap-12 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr]">
            ...
            <div className="footer-links"><b>Plattform</b><a href="/#features">Features</a><a href="/#platform">Ökosystem</a><a href="/#download">Download</a><a href="https://api.seriuxmod.net/api/v1/status/summary">Systemstatus</a></div>
